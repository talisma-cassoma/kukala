...
import "./metadata_DaiqHSLN.mjs";
import { h as renderHead, i as renderComponent, u as renderTemplate } from "./server_Rimude6d.mjs";
...
import { z } from "zod";
//#region src/components/ProductPreview.tsx
function ProductPreview({ productData }) {
	return /* @__PURE__ */ jsx("div", {
		className: "lg:container mx-auto w-full h-full lg:px-0 px-5",
		children: productData ? /* @__PURE__ */ jsx(ProductView, { product: productData.product }) : /* @__PURE__ */ jsx("p", { children: "Product not found" })
	});
}
getSupabaseClient();
//#endregion
...
//#endregion
//#region node_modules/.pnpm/astro@7.1.6_@emnapi+core@1.11.1_@emnapi+runtime@1.11.3_@types+node@26.1.2_@vercel+funct_a7bf5dddaa36fd295a2729af9a65e75d/node_modules/astro/dist/content/utils.js
var entryTypeSchema = z$1.object({ id: z$1.string({ error: "Content entry `id` must be a string" }) }).passthrough();
z$1.union([z$1.array(entryTypeSchema), z$1.record(z$1.string(), z$1.object({ id: z$1.string({ error: "Content entry `id` must be a string" }).optional() }).passthrough())]);
var collectionConfigParser = z$1.union([
	z$1.object({
		type: z$1.literal("content").optional(),
		schema: z$1.any().optional(),
		loader: z$1.never().optional()
	}),
	z$1.object({
		type: z$1.literal("data").optional(),
		schema: z$1.any().optional(),
		loader: z$1.never().optional()
	}),
	z$1.object({
		...
		schema: z$1.any().optional(),
		loader: z$1.union([z$1.function(), z$1.object({
			name: z$1.string(),
			load: z$1.function({
				input: [z$1.custom()],
				output: z$1.custom()
			}),
			schema: z$1.any().transform((v) => {
			...
			createSchema: z$1.function({
				input: [],
				output: z$1.promise(z$1.object({
					schema: z$1.custom((v) => "_zod" in v),
					types: z$1.string()
				}))
			}).optional()
		})])
...
z$1.object({ collections: z$1.record(z$1.string(), collectionConfigParser) });
//#endregion
//#region src/components/addProduct/form/index.tsx
function CreateProductForm({ formMethods }) {
	...
	const handleImageChange = (e) => {
		...
		if (file) {
			...
			setImageFile(file);
			setValue("mainImage.url", localUrl);
		}
	};
	...
	return /* @__PURE__ */ jsxs("form", {
		...
		className: "space-y-8 bg-white p-6 shadow-sm border border-gray-100 rounded-xl h-full overflow-y-auto max-w-4xl mx-auto",
		children: [
			/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h2", {
				...
				children: "Preencha as informações detalhadas para o cadastro do produto."
			})] }),
			/* @__PURE__ */ jsxs("div", {
				className: "space-y-5",
				children: [
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("input", {
							...
							children: "Publicar imediatamente?"
						})]
					}),
					/* @__PURE__ */ jsx("hr", { className: "border-gray-200 my-6" }),
					/* @__PURE__ */ jsxs("div", { children: [
						/* @__PURE__ */ jsx("h3", {
							className: "text-base font-semibold text-gray-800 mb-3",
							children: "Imagem Principal"
						}),
						/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("label", {
						...
						mainImagePreview && /* @__PURE__ */ jsxs("div", {
							className: "mt-2",
							children: [/* @__PURE__ */ jsx("p", {
								className: "text-xs text-gray-500 mb-1",
								children: "Preview interno do Form:"
							}), /* @__PURE__ */ jsx("img", {
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h3", {
								...
								children: "Parágrafos de Conteúdo"
							}), /* @__PURE__ */ jsx("p", {
								className: "text-xs text-gray-500",
								children: "Adicione blocos de texto dinâmicos para a página."
								...
								children: [/* @__PURE__ */ jsx("span", { children: "+" }), " Adicionar Parágrafo"]
							})]
						}), paragraphFields.map((field, index) => /* @__PURE__ */ jsxs("div", {
							className: "border border-gray-200 p-5 rounded-xl space-y-4 bg-gray-50/50 relative shadow-sm group",
							children: [
								/* @__PURE__ */ jsx("button", {
									type: "button",
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [
										...
										/* @__PURE__ */ jsx("label", {
											className: "block text-sm font-medium text-gray-700 mb-1.5",
											children: "Título do Parágrafo"
										}),
										/* @__PURE__ */ jsx("input", {
											...register(`bodyParagraphs.${index}.title`),
			...
			/* @__PURE__ */ jsx("hr", { className: "border-gray-200 mt-8" }),
			/* @__PURE__ */ jsx("button", {
				type: "submit",
				...
				children: "Salvar e Enviar Produto"
			})
		]
	});
}
//#endregion
//#region src/components/addProduct/form/schema.ts
...
//#endregion
//#region src/components/addProduct/index.tsx
var transformFormDataToPreviewData = (formData) => {
	const image = formData.mainImage || {
		url: "",
		altText: "Placeholder",
		file: void 0
	};
	return {
		...
		product: {
			...
			topics: (formData.topics || []).map((t) => ({ name: t?.name ?? t?.id ?? "" })),
			image,
			body: { paragraphs: (formData.bodyParagraphs || []).map((p) => ({
				title: { text: p.title || "" },
				text: p.text || "",
				images: p.images || []
			})) },
			table: { sections: (formData.tableSections || []).map((s) => ({
				title: s.title,
...
function AddNewProduct() {
	...
	return /* @__PURE__ */ jsx("div", {
		className: "box-border h-screenHeight p-8 bg-slate-50 text-slate-900",
		children: /* @__PURE__ */ jsxs("div", {
			className: "box-border h-full mx-auto grid max-w-7xl gap-8 lg:grid-cols-[0.4fr_0.6fr]",
			children: [/* @__PURE__ */ jsx(CreateProductForm, { formMethods }), /* @__PURE__ */ jsx("aside", {
				className: "space-y-6 box-border p-4 h-full overflow-scroll no-scrollbar",
				children: /* @__PURE__ */ jsx("div", {
					className: "rounded-2xl border border-slate-200 bg-primary p-4 overflow-scroll no-scrollbar",
					children: /* @__PURE__ */ jsx(ProductPreview, { productData: previewData })
				})
			})]
		})
	});
...
//#endregion
//#region src/pages/admin/add-product.astro
var add_product_exports = /* @__PURE__ */ __exportAll({
	default: () => $$AddProduct,
	file: () => $$file,
	url: () => $$url
});
var $$AddProduct = createComponent(($$result, $$props, $$slots) => {
	return renderTemplate`<html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>Edit product</title>${renderHead($$result)}</head><body>${renderComponent($$result, "AddNewProduct", AddNewProduct, {
		"client:load": true,
		"client:component-hydration": "load",
		"client:component-path": "@/components/addProduct",
		"client:component-export": "AddNewProduct"
	})}</body></html>`;
}, "/Users/talisma/github-projects/kukala/src/pages/admin/add-product.astro", void 0);
var $$file = "/Users/talisma/github-projects/kukala/src/pages/admin/add-product.astro";
var $$url = "/admin/add-product";
//#endregion
//#region \0virtual:astro:page:src/pages/admin/add-product@_@astro
var page = () => add_product_exports;
//#endregion
export { page };
