import { N as NoImageMetadata, Q as AstroError, X as UnsupportedImageFormat, j as MissingSharp } from "./errors-data_BWcDjAR-.mjs";
import { i as resolveDefaultOutputFormat, r as parseQuality, t as baseService } from "./service_1Kzky1Am.mjs";
import { n as detector } from "./metadata_DaiqHSLN.mjs";
//#region node_modules/.pnpm/astro@7.1.6_@emnapi+core@1.11.1_@emnapi+runtime@1.11.3_@types+node@26.1.2_@vercel+funct_a7bf5dddaa36fd295a2729af9a65e75d/node_modules/astro/dist/assets/services/sharp.js
var sharp;
var qualityTable = {
	low: 25,
	mid: 50,
...
async function loadSharp() {
	let sharpImport;
	try {
		sharpImport = (await import("./dist_CbakWobp.mjs")).default;
	} catch {
